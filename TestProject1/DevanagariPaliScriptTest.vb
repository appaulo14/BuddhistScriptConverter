...
<TestClass()> Public Class DevanagariPaliScriptTest

#Region "Variable Definitions"
    Private testContextInstance As TestContext
    Private Shared target As New DevanagariPaliScript_Accessor
...
#End Region
    ...
    Public Sub Symbols_DeadConsonants_NoGarbageCharactersAdded()
        For Each deadConsonant As String In deadConsonants
            Assert.IsTrue(deadConsonant.IndexOf(ChrWH("094D")) = deadConsonant.Length - 1, _
    ...
    Public Sub Symbols_ṂSymbols_AllSymbolsHaveAnusvaras()
        For Each symbol As String In ṂSymbols
            Assert.IsTrue(symbol.Contains(ChrWH("0902")), symbol & " is missing anusvara")
        Next
    End Sub
